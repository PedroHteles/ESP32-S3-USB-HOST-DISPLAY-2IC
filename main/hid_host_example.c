...
static const char *TAGI2C = "i2c-simple-example";
...
static inline void hid_keyboard_print_char(unsigned int key_char) {
    if (!!key_char) {
        ...
        // Chamar lcd_send_string para escrever na tela do LCD
        char str[2];
        str[0] = key_char;
        str[1] = '\0';
        lcd_send_string(str);
        ...
        if (KEYBOARD_ENTER_MAIN_CHAR == key_char) {
            ...
            // Chamar lcd_send_string para escrever uma nova linha no LCD
            lcd_send_string("\n");
        }
...
void app_main(void)
{
    ...
    ESP_LOGI(TAGI2C, "I2C initialized successfully");
